...
const GAME_DURATION_MS = Math.ceil((COINS_PER_GAME / COINS_PER_SEC) * 1000) + 5_000 // proportional + 5s buffer
...
for (let round = 1; round <= ROUNDS; round++) {
  ...
  console.log(`Server response: total coins=${result.coins}, stamps=${result.collectedStamps}/${result.totalStamps}`)
